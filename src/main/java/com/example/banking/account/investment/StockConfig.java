...
public class StockConfig {
    ...
    private Stock getStockFromLine(String line){
        ...
        int totalTradedValue = (int) Float.parseFloat(fields[8]);
        int totalTradedQuantity = (int) Float.parseFloat(fields[9]);

        return new Stock(symbol, series, open, high, low, close, last, prevClose, totalTradedValue, totalTradedQuantity);
